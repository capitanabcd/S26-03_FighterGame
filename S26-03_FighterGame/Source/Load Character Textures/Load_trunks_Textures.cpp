#include "sfml.h"
void trunks::LoadTexture(std::vector<sf::Texture>& HeavyAttack, std::vector<sf::Texture>& Idle, std::vector<sf::Texture>& Movement, std::vector<sf::Texture>& Stagger, std::vector<sf::Texture>& beam, std::vector<sf::Texture>& ranged, std::vector<sf::Texture>& basic)
{
    std::string folderPath = "assets/trunks/";
